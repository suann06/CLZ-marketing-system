...
// Campaign-scoped Lead detail — same central customer workspace as the
// global /leads/[leadId] route, built from the same shared components.
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div className="flex flex-col gap-6 lg:col-span-2">
          ...
          <Card title="Simulate another message from this customer">
            <SimulateWhatsAppForm campaignId={campaignId} defaultPhone={lead.phone} lockPhone />
          </Card>
        </div>
